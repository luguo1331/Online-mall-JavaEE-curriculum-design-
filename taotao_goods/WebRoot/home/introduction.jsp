...
<link type="text/css"
	href="<c:url value='/css/optstyle.css" rel="stylesheet'/>" />
<link type="text/css"
	href="<c:url value='/css/style.css" rel="stylesheet'/>" />

<script type="text/javascript"
	src="<c:url value='/basic/js/jquery-1.7.min.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/basic/js/quick_links.js'/>"></script>

<script type="text/javascript"
	src="<c:url value='/AmazeUI-2.4.2/assets/js/amazeui.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/js/jquery.imagezoom.min.js'/>"></script>
<script type="text/javascript"
						...
						<div class="am-form-content address">
							<select data-am-selected>
								<c:forEach items="${sessionScope.sessionUser.addressList}"
									...
									<option value="${address.aid}">${address.provincial}${address.city}${address.distric}${address.detailedAddress}</option>
									...
									<div class="theme-signin-left">
										...
										<div class="theme-options">
											...
											<ul>
												...
												<li class="sku-line">炭烧<i></i>
												</li>
												<li class="sku-line">咸香<i></i>
												</li>
											</ul>
										</div>
										<div class="theme-options">
										...
										<div class="theme-options">
											...
											<dd>
												<input id="min" class="am-btn am-btn-default" name=""
													...
													class="tb-hidden">库存<span class="stock">${goods.num}</span>件</span>
											</dd>
	...
	<div class="match">
		...
		<div class="match-comment">
			<ul class="like_list">
				<li>
					<div class="s_picBox">
						<a class="s_pic" href="#"><img src="<%=path%>/images/cp.jpg">
						</a>
				...
				<div class="am-tabs-bd">
					...
					<div class="am-tab-panel am-fade am-in am-active">
						<div class="J_Brand">
							...
							<div class="clear"></div>
							<ul id="J_AttrUL">
								<li title="">产品类型:&nbsp;${goods.type}</li>
								<li title="">原料产地:&nbsp;${goods.materialsProduction}</li>
								<li title="">产地:&nbsp;${goods.production}</li>
								<li title="">配料表:&nbsp;${goods.batching}</li>
								<li title="">产品规格:&nbsp;${goods.spec}g</li>
								<li title="">保质期:&nbsp;${goods.expirationDate}天</li>
								<li title="">产品标准号:&nbsp;${goods.productStandardNumber}</li>
								<li title="">生产许可证编号：&nbsp;${goods.productionLicenseNumber}</li>
								<li title="">储存方法：&nbsp;${goods.storageMethod}</li>
								<li title="">食用方法：&nbsp;${goods.edibleMethod}</li>
							</ul>
							<div class="clear"></div>
						</div>
						...
						<div class="details">
							...
							<div class="twlistNews">
								<img src="<%=path%>/images/tw1.jpg" /> <img
									src="<%=path%>/images/tw2.jpg" /> <img
									src="<%=path%>/images/tw3.jpg" /> <img
									src="<%=path%>/images/tw4.jpg" /> <img
									src="<%=path%>/images/tw5.jpg" /> <img
									src="<%=path%>/images/tw6.jpg" /> <img
									src="<%=path%>/images/tw7.jpg" />
							</div>
						</div>
						<div class="clear"></div>
