...
<link
	href="<c:url value='/AmazeUI-2.4.2/assets/css/admin.css"
	rel="stylesheet" type="text/css'/>" />

<link
	href="<c:url value='/basic/css/demo.css" rel="stylesheet"
	type="text/css'/>" />

<link
	href="<c:url value='/css/seastyle.css" rel="stylesheet"
	type="text/css'/>" />
						...
						<ul class="select">
							<p class="title font-normal">
								<span class="fl">松子</span> <span class="total fl">搜索到<strong
									class="num">997</strong>件相关商品</span>
							</p>
							<div class="clear"></div>
							...
							<c:forEach items="${pagebean.beanList}" var="goods">
								<li>
									<div class="i-pic limit">
										<a
											href="<c:url value='/GoodsServlet?method=findByGid&gid=${goods.gid}'/>">
											<img src="<%=path%>/${goods.image_2}" />
											<p class="title fl">【良品铺子旗舰店】${goods.gname}</p>
											<p class="price fl">
												<b>¥</b> <strong>${goods.price}</strong>
											</p>
											<p class="number fl">
