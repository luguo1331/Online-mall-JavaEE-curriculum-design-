...
<link rel="stylesheet"
	href="<%=path%>/AmazeUI-2.4.2/assets/css/amazeui.css" />
			...
			<div class="login-box">
					...
					<form action="<c:url value='/UserServlet'/>" method="post">
						...
						<div class="user-name">
							<label for="user"><i class="am-icon-user"></i> </label> <input
								type="text" name="loginname" id="user" placeholder="邮箱/手机/用户名"
								value="${user.loginname }">
						</div>
						<div class="user-pass">
							<label for="password"><i class="am-icon-lock"></i> </label> <input
								type="password" name="loginpass" id="password"
				...
				<div class="login-links">
					<label for="remember-me"><input id="remember-me"
						...
						href="<c:url value='/home/register.jsp'/>"
